...
* AddressSanitizer завдяки shadow memory вже на другій ітерації заповнення, помічає оверфлов та відразу зупиняє процес надаючи детальний трасувальник стеку з точним зазначенням винного рядка коду.
