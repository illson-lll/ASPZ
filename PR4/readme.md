...
```
Стек є найвищою точкою в пам'яті користувача та межа стеку згідно таблиці становить 0x7fffec67a000.
Перевівши в десяткову систему це становить 140737159602176 біт що в свою чергу становить 128 терабайт.  
